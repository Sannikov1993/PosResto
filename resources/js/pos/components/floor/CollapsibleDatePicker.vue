<template>
    <div class="date-picker-wrapper relative">
        ...
        <Transition name="popup">
            <div v-if="showCalendar" class="absolute left-0 right-0 top-full mt-1 bg-dark-800 rounded-xl p-4 shadow-2xl z-50 border border-dark-700/50" @click.stop>
                <!-- Calendar Header -->
                ...
                <div class="grid grid-cols-7 gap-1">
                    <button
                        ...
                        :class="[
                            ...
                            day.isWeekend && !day.isSelected && day.isCurrentMonth && !day.disabled ? 'text-red-400 hover:text-red-300' : ''
                        ]"
                    >
                        {{ day.day }}
                    </button>
                ...
                <div class="flex gap-2 mt-4 pt-3 border-t border-dark-700">
                    <button
                        ...
                        :class="[
                            ...
                            isSelectedToday ? 'bg-accent text-white' : 'bg-dark-700 text-gray-400 hover:bg-dark-600 hover:text-white'
                        ]"
                    >
                        Сегодня
                    </button>
                    <button
                        ...
                        :class="[
                            'flex-1 py-2 text-sm rounded-lg font-medium transition-colors',
                            isSelectedTomorrow ? 'bg-accent text-white' : 'bg-dark-700 text-gray-400 hover:bg-dark-600 hover:text-white'
                        ]"
                    >
                        Завтра
                    </button>
                    <button
                        ...
                        :class="[
                            'flex-1 py-2 text-sm rounded-lg font-medium transition-colors',
                            isSelectedDayAfter ? 'bg-accent text-white' : 'bg-dark-700 text-gray-400 hover:bg-dark-600 hover:text-white'
                        ]"
                    >
                        Послезавтра
                    </button>
