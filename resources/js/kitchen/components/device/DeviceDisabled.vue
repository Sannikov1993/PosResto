<template>
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-red-900/30">
...
<script setup>
/**
 * Device Disabled Component
 *
 * Displays when device has been disabled by admin.
 */
